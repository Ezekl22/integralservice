...
define('BOTONES_POPUP_ANULAR', array(["texto" => "Cancelar", "tipo" => "button", "href" => ""], ["texto" => "Anular", "tipo" => "a", "href" => "index.php?module=" . (isset($_GET["module"]) ? $_GET["module"] : "") . "presupuestos&action=annulled&id=" . (isset($_GET["id"]) ? $_GET["id"] : ""), "onclick" => ""]));
