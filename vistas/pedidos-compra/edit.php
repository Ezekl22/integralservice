...
$GestionPantallasCtr = new GestionPantallasCtr();
    ...
    <body>
        <main class="d-flex flex-column align-items-center mt-2" id="editPedido">
            <article class="editar__contenedor rounded-4">
                <form action="index.php?module=pedidos" method="POST"
                    ...
                    <div class="d-flex flex-column align-items-center contenedor__mayor" id="contenedor">
                        ...
                        <div class="my-3 d-flex flex-row w-100">
                            ...
                            <div class="input-group input-group-sm mx-7">
                                ...
                                <input type="text" disabled class="form-control" aria-label="Sizing example input"
                                    ...
                                    value="<?php echo $pedidoCompraCtr->pedidoSeleccionado['nrocomprobante'] ?>" required>
                            </div>
                        </div>
                        <div class="my-3 d-flex flex-row w-100">
                            <div class="input-group input-group-sm ms-7">
                                ...
                                <input type="text" disabled class="form-control" aria-label="Sizing example input"
                                    ...
                                    value="<?php echo $pedidoCompraCtr->pedidoSeleccionado['estado'] ?>" required>
                            </div>
                            <div class="input-group input-group-sm mx-7">
                                ...
                                <input type="text" disabled class="form-control" aria-label="Sizing example input"
                                    ...
                                    value="<?php echo $pedidoCompraCtr->pedidoSeleccionado['fecha'] ?>" required>
                            </div>
                        </div>
                        ...
                        <input class="btn button my-2" type="submit" value="Guardar cambios"
                            onclick="guardarEdicion('editPedido')">
                    </div>
                </form>
            </article>
