            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-flex flex-column">
                    <label class="mb-4 mx-5">
                        ¿Esta seguro/a que desea cancelar el presupuesto seleccionado?
                    </label>
                </div>
                <div class="modal-footer d-flex justify-content-center headerPop__background">
                    <button type="button" class="btn button me-5" data-bs-dismiss="modal">Atras</button>
                    <a aria-label="Close" class="btn button " href="index.php?module=presupuestos&action=canceled&id=<?php echo $_GET['id']?>">Cancelar presupuesto</a>
                </div>
            </div>
        </div>
    </div>
