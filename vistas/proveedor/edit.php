                        ...
                        <div class="d-flex flex-column align-items-center" id="contenedor">
                            ...
                            <div class="my-3 d-flex flex-row">
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" id="nombre" name="nombre" value="<?php echo $proveedorr['nombre']; ?>" required>
                                </div>
                                ...
                                <div class="input-group input-group-sm mb-3 ms-5">
                                    ...
                                    <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" id="direccion" name="direccion" value="<?php echo $proveedorr['direccion']; ?>" required>
                                </div>
                            </div>
                            <div class="d-flex flex-row">
                                <div class="input-group input-group-sm mb-3 ms-5">
                                    <label class="input-group-text" for="telefono" id="inputGroup-sizing-sm">Telefono:</label>
                                    <input type="number" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" id="telefono" name="telefono" value="<?php echo $proveedorr['telefono']; ?>" required>
                                </div>
                                <div class="input-group input-group-sm mb-3 ms-5">
                                    <label class="input-group-text" for="correo" id="inputGroup-sizing-sm">Correo:</label>
                                    <input type="email" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" id="correo" name="correo" value="<?php echo $proveedorr['correo']; ?>" required>
                                </div>
                                <div class="input-group input-group-sm mb-3 ms-5">
                                    <label class="input-group-text" for="saldo" id="inputGroup-sizing-sm">Saldo:</label>
                                    <input type="number" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" id="saldo" name="saldo" value="<?php echo $proveedorr['saldo']; ?>" required>
                                </div>
                                <div class="input-group input-group-sm mb-3 ms-5">
                                    <label class="input-group-text" for="saldo" id="inputGroup-sizing-sm">Fecha:</label>
                                    <input type="text" class="form-control" disabled aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" id="saldo" name="saldo" value="<?php echo $fecha->format('Y-m-d'); ?>" required>
                                </div>
                            </div>
